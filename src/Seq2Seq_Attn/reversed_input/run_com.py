...
from Seq2Seq_Attn.reversed_input.data_com import training_pairs, test_pairs, master_data, input_lang, output_lang
from Seq2Seq_Attn.reversed_input.data_com import MAX_LENGTH, pairs_tr as pairs1, pairs_te as pairs2
