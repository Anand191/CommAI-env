...
for i in range(1):
    ...
    test_acc = trainIters(encoder1, attn_decoder1, 200, training_pairs,test_pairs, use_cuda, print_every=10, plot_every=10)
    test_accs[i,0] = i
...
evaluateAndShowAttention("t2 00",encoder1,attn_decoder1,master_data_te, input_lang2, output_lang2, use_cuda, "test1")
evaluateAndShowAttention("t3 01",encoder1,attn_decoder1,master_data_te, input_lang2, output_lang2, use_cuda, "test1")

evaluateAndShowAttention("t4 t3 10",encoder1,attn_decoder1,master_data_te, input_lang2, output_lang2, use_cuda, "test1")
evaluateAndShowAttention("t3 t2 11",encoder1,attn_decoder1,master_data_te, input_lang2, output_lang2, use_cuda, "test1")

evaluateAndShowAttention("t1 t1 11",encoder1,attn_decoder1,master_data_te, input_lang2, output_lang2, use_cuda, "test1")
evaluateAndShowAttention("t2 t2 00",encoder1,attn_decoder1,master_data_te, input_lang2, output_lang2, use_cuda, "test1")
