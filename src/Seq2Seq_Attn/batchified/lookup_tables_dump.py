...
class lookup_tables(object):
    ...
    def gen_all_data(self):
        ...
        heldout = self.all_objects(train_split[:,1])
        ...
        heldout_composed = self.gen_table_dicts(heldout, train_tasks, 2)
        ...
        return (atomic_dict, train_composed, heldout_composed, test11_subset, test12_subset, test11_hybrid,
