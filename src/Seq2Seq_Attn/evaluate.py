...
from Seq2Seq_Attn.data_prep import variableFromSentence,input_lang,output_lang,SOS_token,EOS_token
from Seq2Seq_Attn.data_prep import master_data,MAX_LENGTH,pairs
import numpy as np
import random
